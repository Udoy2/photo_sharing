    ...
    <div class="card-body">
        <form action="{{action('ClientController@update', $user->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <label for="avatar-img" class="btn btn-info rounded-pill ml-3 mt-2">Avatar</label>
                <input type="file"  class="form-control" name="avatar" id="avatar-img" style="display: none !important;">
